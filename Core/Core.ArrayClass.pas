unit Core.ArrayClass;

interface

uses
  System.SysUtils, System.Classes, System.SyncObjs, Core.ArrayIntf;
...
procedure TSimpleInterfaceArray.ForAll(AApplyFunction: IApplyFunctionItemArray);
var
  laco: Integer;
  LItem: IUnknown;
begin
...
procedure TSimpleInterfaceArray.SetInterfaces(Index: Integer; const Value: IUnknown);
begin
  FList[Index] := Value;
end;
...
procedure TSparseInterfaceArray.ForAll(AApplyFunction: IApplyFunctionItemArray);
var
  laco: Integer;
begin
...
function TSparseInterfaceArray.GetSection(Index: Integer; ACreate: Boolean): IInterfaceArray;
var
...
procedure TSparseInterfaceArray.SetInterfaces(Index: Integer; const Value: IUnknown);
var
  LSection: IInterfaceArray;
begin
  FCriticalSection.Acquire;
