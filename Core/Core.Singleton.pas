...
uses
  System.SysUtils, System.SyncObjs, Core.ArrayIntf, Core.ArrayClass;
...
type
  ...
  IInstancesSingleton = interface
    ...
    property InstanceSingleton[AClass: TClass]: IInstanceSingleton read GetInstanceSingleton; default;
  end;
...
function TInstancesSingleton.GetInstanceSingleton(AClass: TClass): IInstanceSingleton;
begin
