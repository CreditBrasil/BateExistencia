...
function ExecutaGeraHTML (GeraHTML) {
  ...
  var arqs = arquivos(GeraHTML.CaminhoHTML, GeraHTML.Projeto + ".", "html");
  for(var iArq = 0; iArq < arqs.length; iArq++) {
    var strHTML = leArquivo(GeraHTML.CaminhoHTML + "\\" + arqs[iArq]);
  
    Configuracao.NomeArquivoDesmembrado = arqs[iArq].split(".");
    ...
    Configuracao.NomeUnit = Configuracao.NomeProjeto + ".Visao." + Configuracao.NomeControlador + "." + Configuracao.NomeVisao;
